...
class EventsClientTests(TestCase):
    ...
    def test_work_available_event_calls_handler(self):
        ...
        self._push_metrics_handler.assert_not_called()
    ...
    def test_heartbeat_with_push_metrics_calls_handler(self):
        """Test that heartbeat with push_metrics flag calls push_metrics_handler."""
        self._client.start(
            work_available_handler=self._work_available_handler,
            push_metrics_handler=self._push_metrics_handler,
        )
        ...
        self._heartbeat_checker.heartbeat_received.assert_called_once()
        self._push_metrics_handler.assert_called_once()
    ...
    def test_stop_clears_handlers(self):
        ...
        self.assertIsNone(self._client._push_metrics_handler)
